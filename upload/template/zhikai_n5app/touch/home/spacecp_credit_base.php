			...
			<input type="hidden" name="outi" value="" />
				...
				<div class="jfzz_zzxm cl">	
					...
					<div class="zzxm_xmnr z">
						...
						<p class="d"><!--{if $_G[setting][exchangemincredits]}-->{lang memcp_credits_exchange_min_balance} $_G[setting][exchangemincredits]<!--{/if}--><span id="taxpercent"><!--{if intval($taxpercent) > 0}-->, {lang credits_tax} $taxpercent<!--{/if}--></span></p>
					</div>
				</div>
				<div class="jfzz_zzxm cl">
				    <div class="zzxm_xmbt z">{lang transfer_login_password}</div>
