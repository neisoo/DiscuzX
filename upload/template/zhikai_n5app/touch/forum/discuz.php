			...
			<ul>
				...
				<!--{if $favforumlist[$favorite[id]]}-->
					...
					<div class="bklb_bsbt cl">
						...
						<h2><!--{if $n5app['bbsbkys'] == 1}-->$forum[name]<!--{elseif $n5app['bbsbkys'] == 2}--><!--{echo cutstr($forum[name],10)}--><!--{/if}--><!--{if $forum[todayposts] > 0}--><span>$forum[todayposts]</span><!--{/if}--></h2>
						<p><!--{if $n5app['bbsbkys'] == 1}--><!--{if $forum[description]}--><!--{echo cutstr($forum[description],30)}--><!--{else}-->{$n5app['lang']['qjywkfssd']}<!--{/if}--><!--{elseif $n5app['bbsbkys'] == 2}--><!--{if empty($forum[redirect])}-->{$n5app['lang']['sqzhutisl']}:<!--{echo dnumber($forum[threads])}--> {$n5app['lang']['sqzhutits']}:<!--{echo dnumber($forum[posts])}--><!--{/if}--><!--{/if}--></p>
						</a>
					</div>
					<!--{if $n5app['bbsbkys'] == 1}-->
