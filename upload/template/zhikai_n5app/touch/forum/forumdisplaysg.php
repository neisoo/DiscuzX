...
<div class="sqys_pyqs cl">
	...
	<div class="pyqs_ztnr cl">
		...
		<div class="pyqs_qwsqkz">
			<div class="pyqs_nrxx cl"><a href="forum.php?mod=viewthread&tid=$thread[tid]&fromguid=hot&{if $_GET['archiveid']}archiveid={$_GET['archiveid']}&{/if}extra=$extra"><!--{if $isvideo}-->{$n5app['lang']['ztnrfxdmt']}<!--{/if}-->$messag</a></div>
		</div>
		<!--{if $isvideo}--><!--{else}-->
		...
		<!--{/if}-->
		<div class="n5_htnrspp cl"><!--{hook/forumdisplay_threadnlbsp_mobile $key}--></div>
	</div>
