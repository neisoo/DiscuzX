...
<style type="text/css">.bg {background: #fff;}.tshuz_smslogin {display:none!important;}.n5_wbdlkz,.n5qj_ancd {display: none;}</style>
...
{if $n5app['dsfdlkz']}
	<div class="qtdl_dlxx cl">
		<ul>
			...
			<li><a href="plugin.php?id=zhikai_sms:phone_login&mobile=2"><img src="template/zhikai_n5app/images/n5dl_sjdl.png"><p>{$n5app['lang']['qtdlsjdl']}</p></a></li>
		</ul>
	</div>
{/if}
	<script type="text/javascript">
