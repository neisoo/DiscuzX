...
function ShareBnt(){
	var fx = GetFxList();
	if(fx){
		YDB.Share(fx.title, fx.desc, fx.imgUrl,fx.link,"Shareback");
	}else{
		alert('no data');
	}
}
...
<div class="n5sq_ksfb cl">
	...
	<button class="ksfb_qxan nbg"><i class="iconfont icon-n5appkfgb"></i></button>
</div>
...
jq(function(){     
	...
	var header_yuksekligi = jq('.n5qj_top').outerHeight();
    jq(window).scroll(function() {  
        ...
        else {jq('.n5sq_flfb').addClass('n5sq_flfbx');}  
