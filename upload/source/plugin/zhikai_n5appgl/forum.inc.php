...
if(submitcheck("submit")){
	...
	$pluginvarid = DB::result_first("SELECT pluginvarid FROM %t WHERE pluginid=%d AND variable= 'forumstyles'",array("common_pluginvar",$plugin['pluginid']));
	$pluginvars = array();
...
function showsettingselect($fid){
	...
	$setting = dunserialize( $_G['cache']['plugin']['zhikai_n5appgl']['forumstyles'] );
